...
class GaitSequenceDataset(data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        sample = {'sequence' : torch.FloatTensor(self.sequences[idx]),
                    'piano_roll' : torch.LongTensor(self.piano_rolls[idx]),
...
#     # if data['sequence_length'] > data['piano_roll'].shape[0]:
#     #     print('111111111111111111')
#     # if data['sequence_length'] < data['piano_roll'].shape[0]:
#     #     print('222222222222222222')
#     # print(data['sequence_length'], data['piano_roll'].shape[0], data['file_name'], data['frame'], data['leg'])
#     print(data['sequence_length'], data['piano_roll'].shape[0], data['leg'])
#     if idx == 500:
#         break